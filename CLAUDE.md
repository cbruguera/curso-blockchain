...
Material docente para impartir un curso de blockchain de **8 horas** (`curso-8h/`, 8 bloques de 55 min),
apoyado en un banco de contenido más amplio (`material-extendido/`) y en un proyecto propio
(`proyecto-voz/`) que sostiene los bloques 6-8.

## Idioma

**Todo el contenido del repositorio se escribe en español** (slides, guías, material de estudio,
nombres de archivo, commits). La conversación con el usuario puede ser en cualquier idioma.

## Público

Cualquiera puede ser el alumno: emprendedores, juristas, técnicos. **No se asume perfil jurídico ni
técnico**, ni se escribe material separado por perfil: un solo texto, una sola lectura. El ángulo
jurídico-probatorio guía qué temas entran y en qué orden, no el tono ni el vocabulario.

## Productos por bloque

1. **`slides.md`** — para proyectar (formato Marp).
